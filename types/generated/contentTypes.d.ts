...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Authors: Attribute.Relation<
      ...
      'api::person.person'
    >;
    Content: Attribute.DynamicZone<['article.basic-text']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    LengthInHours: Attribute.Decimal &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    EventLocation: Attribute.Relation<
      'api::event.event',
      'oneToOne',
...
export interface ApiGlobalInformationGlobalInformation
  ...
  attributes: {
    Sections: Attribute.Component<'footer.section', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLinkInBioLinkInBio extends Schema.SingleType {
  ...
  attributes: {
    Link: Attribute.Component<'general.link', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
