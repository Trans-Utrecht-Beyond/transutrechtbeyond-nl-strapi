...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Authors: Schema.Attribute.Relation<'oneToMany', 'api::person.person'>;
    Content: Schema.Attribute.DynamicZone<['article.basic-text']> &
    ...
    Listed: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    EventLocation: Schema.Attribute.Relation<
      'oneToOne',
      'api::event-location.event-location'
    >;
    EventType: Schema.Attribute.Relation<
      ...
      'api::event-type.event-type'
    >;
    ExtraDescription: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Host: Schema.Attribute.Relation<'oneToOne', 'api::person.person'>;
    LengthInHours: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiGlobalInformationGlobalInformation
  ...
  info: {
    description: '';
    displayName: 'Global Information';
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    Sections: Schema.Attribute.Component<'footer.section', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLinkInBioLinkInBio extends Struct.SingleTypeSchema {
  collectionName: 'link_in_bios';
  info: {
    displayName: 'LinkInBio';
    pluralName: 'link-in-bios';
    singularName: 'link-in-bio';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Link: Schema.Attribute.Component<'general.link', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::link-in-bio.link-in-bio'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPermalinkPermalink extends Struct.CollectionTypeSchema {
...
export interface ApiPersonPerson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    BoardMember: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
